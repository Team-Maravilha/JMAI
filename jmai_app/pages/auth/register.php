                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        <form class="form w-100" novalidate="novalidate" id="login-form">
                            ...
                            <div class="row g-3 mb-9 justify-content-center">
                                <div class="col-md-6">
                                    <a href="login-user.php" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                            ...
                            <div class="text-gray-500 text-center fw-semibold fs-6">Ainda não tem registo?
                                <a href="authentication/layouts/creative/sign-up.html" class="link-primary">Registar</a>
                            </div>
                        </form>
                    </div>
                </div>
