...
<?php $page_name = "Editar Utilizador- Médico" ?>
                                                ...
                                                <div class="card-body">
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            ...
                                                            <select class="form-select form-select-solid form-control-lg" name="estado" autocomplete="off" data-control="select2" data-hide-search="true" data-placeholder="Selecione um Estado">
                                                                <option></option>
