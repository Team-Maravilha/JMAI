    ...
    <script>
        ...
        var rejectRequest = () => {
            Swal.fire({
                ...
                inputAttributes: {
                    autocapitalize: "off",
                    placeholder: "Por favor indique o motivo da recusa do requerimento...",
                    class: "form-control",
                    style: "outline: none; resize: none; height: 150px;box-shadow: none; border: 1px solid #d3d3d3; border-radius: 6px; padding: 10px;"
                },
                showCancelButton: true,
                showConfirmButton: true,
