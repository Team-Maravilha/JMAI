...
<?php $page_name = "Adicionar Novo Utilizador - Médico" ?>
...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="false" data-kt-app-sidebar-fixed="false" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                            ...
                            <div id="kt_app_content" class="app-content">
                                ...
                                <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start  container-xxl ">
                                    <div class="content flex-row-fluid" id="kt_content">
                                        <form id="form-adicionar-medico" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row mb-6">
    ...
    <script>
        const form = document.getElementById("form-adicionar-medico");
        ...
        function handleAdicionar(event) {
            ...
            var form = document.getElementById("form-adicionar-medico");
            ...
            fetch(`${api_base_url}utilizadores/registar/medico`, requestOptions)
